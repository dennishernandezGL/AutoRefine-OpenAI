...
const PaymentForm: FunctionComponent<PaymentFormProps> = ({
  ...
  const validationSchema = Yup.object({
    ...
    cardNumber: Yup.string().matches(cardNumberRegex, 'Enter a valid credit card number').required('Card Number is required'),
    expirationDate: Yup.string().matches(expirationDateRegex, 'Enter a valid expiration date in MM/YY format').required('Expiration Date is required'),
    cvv: Yup.string().matches(cvvRegex, 'Enter a valid CVV').required('CVV is required'),
    billingAddress: Yup.string().required('Billing Address is required'),
    billingAddress2: Yup.string(),
    ssn: Yup.string().matches(ssnRegex, 'Enter a valid SSN'),
    phone: Yup.string(),
    country: Yup.string(),
  });
          ...
          <Form>
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <FormField name='cardNumber' type='password' label='Credit Card Number' error={touched.cardNumber && Boolean(errors.cardNumber)} />
              </Grid>
              ...
              <Grid size={{ xs: 12, md: 2 }}>
                <FormField name='cvv' type='password' label='CVV' error={touched.cvv && Boolean(errors.cvv)} />
              </Grid>
              ...
              {/* SSN */}
              <Grid size={{ xs: 12, md: 4 }}>
                <FormField name='ssn' type='password' label='Social Security Number' error={touched.ssn && Boolean(errors.ssn)} />
              </Grid>
