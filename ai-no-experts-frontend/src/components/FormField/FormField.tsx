...
const FormField: FunctionComponent<FormFieldProps> = ({
    ...
    const startAdornmentElement = startAdornment ? <InputAdornment position="start">{startAdornment}</InputAdornment> : null;
    const endAdornmentElement = endAdornment ? <InputAdornment position="end">{endAdornment}</InputAdornment> : null;
    return (
